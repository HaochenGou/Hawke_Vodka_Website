...
var _ProductGridSingle = _interopRequireDefault(require("../../components/product/ProductGridSingle"));
...
var ProductGrid = function ProductGrid(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, products.map(function (product) {
    return /*#__PURE__*/_react.default.createElement(_ProductGridSingle.default, {
