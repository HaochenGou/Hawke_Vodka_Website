...
var _ProductGridListSingle = _interopRequireDefault(require("../../components/product/ProductGridListSingle"));
...
var ProductGrid = function ProductGrid(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, products.map(function (product) {
    return /*#__PURE__*/_react.default.createElement(_ProductGridListSingle.default, {
...
var _default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ProductGrid);
