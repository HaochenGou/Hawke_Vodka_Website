...
var _ProductGridSingleThree = _interopRequireDefault(require("../../components/product/ProductGridSingleThree"));
...
var ProductGridThree = function ProductGridThree(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, products.map(function (product) {
    return /*#__PURE__*/_react.default.createElement(_ProductGridSingleThree.default, {
...
var _default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ProductGridThree);
