...
var _ProductImageGallery = _interopRequireDefault(require("../../components/product/ProductImageGallery"));

var _ProductDescriptionInfo = _interopRequireDefault(require("../../components/product/ProductDescriptionInfo"));

var _ProductImageGallerySideThumb = _interopRequireDefault(require("../../components/product/ProductImageGallerySideThumb"));

var _ProductImageFixed = _interopRequireDefault(require("../../components/product/ProductImageFixed"));
...
var ProductImageDescription = function ProductImageDescription(_ref) {
  ...
  }, galleryType === "leftThumb" ? /*#__PURE__*/_react.default.createElement(_ProductImageGallerySideThumb.default, {
    product: product,
    thumbPosition: "left"
  }) : galleryType === "rightThumb" ? /*#__PURE__*/_react.default.createElement(_ProductImageGallerySideThumb.default, {
    product: product
  }) : galleryType === "fixedImage" ? /*#__PURE__*/_react.default.createElement(_ProductImageFixed.default, {
    product: product
  }) : /*#__PURE__*/_react.default.createElement(_ProductImageGallery.default, {
    product: product
  })), /*#__PURE__*/_react.default.createElement("div", {
    className: "col-lg-6 col-md-6"
...
ProductImageDescription.propTypes = {
  ...
  galleryType: _propTypes.default.string,
