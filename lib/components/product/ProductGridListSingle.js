...
var ProductGridListSingle = function ProductGridListSingle(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
    className: "col-xl-4 col-sm-6 ".concat(sliderClassName ? sliderClassName : "")
    ...
    target: "_blank"
  }, " ", "Buy now", " ") : product.variation && product.variation.length >= 1 ? /*#__PURE__*/_react.default.createElement(_reactRouterDom.Link, {
    to: "".concat(process.env.PUBLIC_URL, "/product/").concat(product.id)
  }, "Learn More") : product.stock && product.stock > 0 ? /*#__PURE__*/_react.default.createElement("button", {
    onClick: function onClick() {
    ...
    to: process.env.PUBLIC_URL + "/product/" + product.id
  }, product.name)), product.rating && product.rating > 0 ? /*#__PURE__*/_react.default.createElement("div", {
    ...
    ratingValue: product.rating
  }))) : "", product.shortDescription ? /*#__PURE__*/_react.default.createElement("p", null, product.shortDescription) : "", /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "shop-list-compare ml-10"
  }, /*#__PURE__*/_react.default.createElement("button", {
...
var _default = ProductGridListSingle;
